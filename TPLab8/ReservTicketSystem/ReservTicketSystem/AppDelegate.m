...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@"HasLaunchedOnce"])
    {
        ...
        firstFlight.cityTo = @"Vilnius";
        firstFlight.aviaCompany = @"BelAvia";
        firstFlight.dateTime = @"14.07.2016 14:00";
        ...
        secondFlight.cityFrom = @"Minsk";
        secondFlight.cityTo = @"Vilnius";
        secondFlight.aviaCompany = @"VilAvia";
        secondFlight.price = [NSNumber numberWithInt:2000.0];
        secondFlight.dateTime =@"15.07.2016 15:00";
        ...
        thirdFlight.cityFrom = @"Warsaw";
        thirdFlight.cityTo = @"Minsk";
        thirdFlight.aviaCompany = @"PolAirLines";
        thirdFlight.price = [NSNumber numberWithInt:500.0];
        thirdFlight.dateTime =@"05.10.2016 6:00";
        ...
        fourthFlight.cityTo = @"Warsaw";
        fourthFlight.aviaCompany = @"BelAvia";
        fourthFlight.dateTime =@"07.09.2016 6:15";
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "by.bsu.fpmi.ReservTicketSystem" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ReservTicketSystem" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ReservTicketSystem.sqlite"];
    NSError *error = nil;
